...
/*
 * !!! THIS SOURCE FILE WAS TAKEN FROM APACHE CASSANDRA SOURCE !!!
 *
...
{
  public static int[] multiSeedHash32(long data, int[] seeds) {
    int[] res = new int[seeds.length];
    for(int i = 0; i < seeds.length; i++) {
      res[i] = hash32(data, seeds[i]);
    }
    return res;
  }

  public static int[] multiSeedHash32(int data, int[] seeds) {
    int[] res = new int[seeds.length];
    for(int i = 0; i < seeds.length; i++) {
      res[i] = hash32(data, seeds[i]);
    }
  ...
  public static int[] multiSeedHash32(String data, int[] seeds) {
    int[] res = new int[seeds.length];
    for(int i = 0; i < seeds.length; i++) {
      res[i] = hash32(data, seeds[i]);
    }
  ...
  public static int[] multiSeedHash32(ByteBuffer data, int offset, int length, int[] seeds) {
    int[] res = new int[seeds.length];
    for(int i = 0; i < seeds.length; i++) {
      res[i] = hash32(data, offset, length, seeds[i]);
    }
    return res;
  }
  ...
  public static int hash32(String data, int seed){
    ...
    return  hash32(bb, 0, bytes.length, seed);
  }
